...
class TestFFT(unittest.TestCase):
    def test_move_entity(self):
        ...
        prevEntity = game.entities[0]
        for i in range(1, len(game.entities)):
            self.assertTrue(game.entities[i].speed >= prevEntity.speed)
            prevEntity = game.entities[i]
